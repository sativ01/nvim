  ...
  "nvim-neo-tree/neo-tree.nvim",
    ...
    config = function ()
      ...
      require("neo-tree").setup({
        -- auto close file explorer on file open event
        event_handlers = {
          {
            event = "file_opened",
        ...
        window = {
          ...
          mappings = {
            ...
            ["cn"] = "copy", -- takes text input for destination, also accepts the optional config.show_path option like "add":
            ["c"] = {
              "copy",
              config = {
      ...
      vim.keymap.set("n", "<leader>e", ":Neotree toggle<cr>", {desc = "Show file explorer"})
